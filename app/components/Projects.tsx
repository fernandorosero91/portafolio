...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      status: 'production',
      icon: 'M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z', // Icono de documento/factura
      demoUrl: null,
      features: ['DIAN compliance', 'Automatic tax calculation', 'PDF generation']
    },
    {
      ...
      status: 'testing',
      icon: 'M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.84 3.75 3.97V22h2.5v-9.03C11.34 12.84 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z', // Icono de restaurante/cubiertos
      demoUrl: 'https://restaurante.gestionxpress.app/',
      features: ['Order management', 'Inventory control', 'Billing system']
    },
    {
      ...
      status: 'testing',
      icon: 'M20 2H4c-1 0-2 .9-2 2v3.01c0 .72.43 1.34 1 1.69V20c0 1.1 1.1 2 2 2h14c.9 0 2-.9 2-2V8.7c.57-.35 1-.97 1-1.69V4c0-1.1-1-2-2-2zm0 2v3H4V4h16zM4 20v-9h16v9H4zm8-7c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z', // Icono de caja registradora/inventario
      demoUrl: 'https://pos.gestionxpress.app/',
      features: ['Stock management', 'Sales tracking', 'Financial reports']
    },
  ];
              ...
              <div key={index} ref={ref} className={`project-card scroll-reveal-scale ${isVisible ? 'visible' : ''}`}>
                ...
                <div className="project-actions">
                  {project.demoUrl ? (
                    ...
                    <button className="btn-project btn-demo btn-disabled btn-demo-full" disabled>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
          ...
          <div ref={fRef} className={`scroll-reveal ${fv ? 'visible' : ''}`}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 p-7 rounded-2xl border" style={{ backgroundColor: 'rgba(74,111,168,0.03)', borderColor: 'var(--border-color)' }}>
              ...
              <button type="submit" disabled={submitting} className="btn-filled w-full py-3 rounded-xl text-sm font-semibold text-white disabled:opacity-60 disabled:hover:translate-y-0" style={{ backgroundColor: 'var(--primary-blue)' }}>
